...
def points2heightmap(surface_pts, heightmap_size, ws_limits=[[-0.5,0.5],[-0.2,0.4],[0.1, 0.7]]):
...
def main(args):
    ...
    fname = 'depth_%07d.'%(idx_st) + f_format
